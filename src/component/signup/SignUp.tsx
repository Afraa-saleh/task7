  ...
  return (
    <div className='fixed inset-0 z-50 flex items-center justify-center bg-black/60'>
      <div className='bg-white rounded-xl shadow-xl w-full max-w-md p-6 relative animate-fade-in'>
        ...
        <h2 className='text-2xl lg:text-4xl font-bold text-textc mb-6'>Create Account</h2>

        <form className='space-y-3 lg:space-y-6'>
          <div>
            <label className='font-medium text-textc/80'>Name and Surname</label>
          ...
          <div className='relative'>
            ...
            <button
              ...
              {showPassword ? <FaEyeSlash size={20} /> : <FaEye size={20} />}</button>
            ...
            <div className='flex items-center mt-4'>
              <input
                type='checkbox'
                id='remember'
                className='mr-2 accent-mainBg'
              />
              <label htmlFor='remember' className='text-sm text-textc/70 font-medium'>
                I agree with <span className='text-mainBg'>Terms</span> and <span className='text-mainBg'>Privacy</span>
              </label>
            </div>
           ...
           <button type='submit' className='w-full py-2 bg-mainBg text-white rounded-4xl hover:bg-tran hover:border hover:border-mainBg hover:text-mainBg transition cursor-pointer'>Sign In</button>

          <div className='text-center text-gray-400 text-sm'>or</div>

          
           <button type='button' className='w-full flex items-center justify-center gap-2 border border-textc/50 py-2 rounded-4xl text-textc/70 hover:border-mainBg hover:text-mainBg transition cursor-pointer'>
